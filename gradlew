...
# Use the maximum available byte code version be default
JAVA_OPTS="$JAVA_OPTS "-Dorg.gradle.jvmargs="-Xmx2048m -XX:MaxMetaspaceSize=512m""
...
# Increase command line line limit on Windows
